...
# lleg = sub_mesh_cube((0.3,0.7,0.3), (0.16,0.1,0))
# rleg = sub_mesh_cube((0.3,0.7,0.3), (-0.16,0.1,0))
# abdomen = sub_mesh_cube((0.35,0.62,0.4), (0,0.9,0))
# thorax = sub_mesh_cube((0.35,0.30,0.4), (0,1.22,0))
# belly = sub_mesh_cube((0.35,0.32,0.4), (0,0.9,0))
# sex = sub_mesh_sphere(0.15, (0,0.81,0))
# head = sub_mesh_sphere(0.15, (0,1.6,0.03))
# neck = sub_mesh_cube((0.15,0.1,0.15), (0,1.5,0))
# brain = sub_mesh_sphere(0.095, (0,1.68,0.01))

# rleg = sub_mesh_cube((0.3,0.7,0.3), -0.16, 0.1)

# cube = cube_mesh((0.15,0.1,0.15), (0,1.5,0))
cube = sphere_mesh(0.095, (0,1.68,0.01))
# scene = trimesh.Scene([feet1,feet2])
